		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="handlemsg",cond=whenDispatch("outsonarocc"))
				}	 
				state("handlemsg") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t07",targetState="handlemsg",cond=whenTimeout("local_tout_outsonar_handlemsg"))   
					transition(edgeName="t08",targetState="work",cond=whenDispatch("takecar"))
				}	 
			}
		}
}
