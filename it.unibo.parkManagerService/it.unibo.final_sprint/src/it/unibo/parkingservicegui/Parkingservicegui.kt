		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="carEnter",cond=whenReply("informIn"))
				}	 
				state("carEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t01",targetState="saveTOKENID",cond=whenReply("receipt"))
				}	 
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t02",targetState="requestPickup",cond=whenTimeout("local_tout_parkingservicegui_wait"))   
				}	 
				state("requestPickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t03",targetState="handlerResponsePickup",cond=whenReply("ok"))
				}	 
