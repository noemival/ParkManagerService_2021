		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t024",targetState="carEnter",cond=whenReply("informIn"))
				}	 
				state("carEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t025",targetState="saveTOKENID",cond=whenReply("receipt"))
				}	 
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="requestPickup",cond=whenTimeout("local_tout_parkingservicegui_wait"))   
				}	 
				state("requestPickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="handlerResponsePickup",cond=whenReply("ok"))
				}	 
