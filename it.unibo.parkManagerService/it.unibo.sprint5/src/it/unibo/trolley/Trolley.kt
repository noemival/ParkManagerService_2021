		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t12",targetState="working",cond=whenDispatch("trolleycmd"))
					transition(edgeName="t13",targetState="stopped",cond=whenDispatch("trolleystop"))
				}	 
				...
				state("doMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t14",targetState="execPlannedMoves",cond=whenTimeout("local_tout_trolley_doMove"))   
					transition(edgeName="t15",targetState="working",cond=whenDispatchGuarded("trolleycmd",{home == 1 && terminate == 0 
					}))
					transition(edgeName="t16",targetState="stopped",cond=whenDispatch("trolleystop"))
				}	 
				state("stopped") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t17",targetState="execPlannedMoves",cond=whenDispatch("trolleyresume"))
				}	 
